                        ...
                        @foreach($clientes as $cliente)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" href="javascript:(confirm('Deletar esse registro?') ? window.location.href='{{route('cliente.deletar',$cliente->id)}}' : window.location.href='{{route('cliente.index')}}' )">Deletar</a>
